...
- labelは必ず4文字以内。長い概念は短い造語・略語に変換すること（例：「育児との両立不安」→「育児疲」「老後不安」→「老後」「承認欲求」→「いいね欲」「副業」→「副業」「現実逃避」→「逃げたい」）
- 面白い造語・ネット略語・思い切った短縮語を積極的に使う（例：「金欠」「推し沼」「ぴえん」「闇落ち」「草」「詰んだ」「しんどい」「気疲れ」「金・金・金」）
- emojiは各キーワードに合った絵文字1個
- summaryは20〜30文字のキャッチーな一言（例：「老後と推しで頭がいっぱい」）
